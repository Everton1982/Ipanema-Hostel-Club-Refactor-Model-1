...
<body bgcolor="transparent" allowtransparency="true" style="background:transparent !important;">
  <div class="container">
    <form name="frm_fale_conosco" id="frm_fale_conosco" action="../php/postback.php" method="post" onsubmit="return valida_frm()">
      ...
      <fieldset>
        <legend>Preencha o formul&aacute;rio abaixo e aguarde a
        ...
        <p>
          ...
          <table border="0" cellpadding="0" cellspacing="3" class="tipo_quarto" style="margin-left:10px">
            <tr>
        ...
        <table class="table table-responsive" border="0" cellspacing="3" cellpadding="0" style="margin-left:10px">
          <tr>
            ...
            <td width="120">Dia
              ...
              <select name="chegada_dia" class="custom-select" id="chegada_dia" style="width:60px">
            ...
            <td width="120">M&ecirc;s
              <label for="chegada_dia"></label>
              <select name="chegada_mes" class="custom-select" id="select" style="width:60px">
            ...
            <td width="120">Ano
              <label for="chegada_dia"></label>
              <select name="chegada_ano" class="custom-select" id="select" style="width:60px">
            ...
            <td width="120">Hora
              <input type="text" name="chegada_hora" id="tx_privativo_nr_pessoas5" style="width:50px" />
            </td>
          </tr>
          <tr>
            <td>Partida</td>
            <td>Dia
              <label for="chegada_dia"></label>
              <select name="partida_dia" class="custom-select" id="partida_dia" style="width:60px">
                <option value="01">01</option>
                <option value="02">02</option>
                <option value="03">03</option>
                <option value="04">04</option>
            ...
            <td>M&ecirc;s
              <label for="chegada_dia"></label>
              <select name="partida_mes" class="custom-select" id="select" style="width:60px">
                <option value="JANEIRO">JAN</option>
                <option value="FEVEREIRO">FEV</option>
                <option value="MARÇO">MAR</option>
                <option value="ABRIL">ABR</option>
            ...
            <td>Ano
              <label for="chegada_dia"></label>
              <select name="partida_ano" id="select" class="custom-select" style="width:60px">
            ...
            <td>Hora
              <input type="text" name="partida_hora" id="tx_privativo_nr_pessoas6" style="width:50px" />
            </td>
          </tr>
        </table>
        <p>&nbsp;</p>
